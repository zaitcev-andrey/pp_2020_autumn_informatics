...
#define MODULES_TASK_2_SHAGOV_M_GIFT_WARPPING_ALGORITHM_GIFT_WARPPING_ALGORITHM_H_
#include <mpi.h>
#include <vector>
#include <iostream>
#include <ctime>
...
#endif  // MODULES_TASK_2_SHAGOV_M_GIFT_WARPPING_ALGORITHM_GIFT_WARPPING_ALGORITHM_H_