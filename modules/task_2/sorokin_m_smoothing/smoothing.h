...
#ifndef  MODULES_TASK_2_SOROKIN_M_SMOOTHING_SMOOTHING_H_
#define  MODULES_TASK_2_SOROKIN_M_SMOOTHING_SMOOTHING_H_
#include <vector>
...
#endif  //  MODULES_TASK_2_SOROKIN_M_SMOOTHING_SMOOTHING_H_
