...
#ifndef MODULES_TASK_2_SKRIPAL_A_MATRIX_MULT_MATRIXMULT_H_
#define MODULES_TASK_2_SKRIPAL_A_MATRIX_MULT_MATRIXMULT_H_
#include <vector>
...
#endif  //  MODULES_TASK_2_SKRIPAL_A_MATRIX_MULT_MATRIXMULT_H_
