...
#ifndef MODULES_TASK_2_GOGOV_V_BLOCK_STRIPED_COLUMNWISE_H_
#define MODULES_TASK_2_GOGOV_V_BLOCK_STRIPED_COLUMNWISE_H_
#include <vector>
...
#endif  // MODULES_TASK_2_GOGOV_V_BLOCK_STRIPED_COLUMNWISE_H_